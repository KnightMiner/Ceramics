...
/**
 * Small patch to {@link net.minecraftforge.client.model.ItemLayerModel} to fix a bug with quads generating upside down
 *
 * Can remove once MinecraftForge/MinecraftForge#6726 is fixed
 */
public final class ItemLayerModelPatch {
